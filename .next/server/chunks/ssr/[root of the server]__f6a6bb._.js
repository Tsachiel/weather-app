...
const useWeatherQuery = (city)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!city) return;
        setLoading(true);
        fetch(`/api/weather?city=${city}`).then((response)=>response.json()).then((data)=>{
            if (data.error) {
                setError(data.error);
            } else {
                setWeather(data);
        ...
        }).catch(()=>setError("Failed to fetch weather data")).finally(()=>setLoading(false));
    }, [
        city
    ]);
    return {
...
"[project]/lib/abTest.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$abTest$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/abTest.ts [app-ssr] (ecmascript)");
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setVariant((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$abTest$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getVariant"])());
    }, []);
    const handleSearch = async (city)=>{
        try {
            ...
            if (data.length > 0) {
                ...
                const updatedCities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addToRecentCities"])(city);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f6a6bb._.js.map